...
var ErrInvalidPasetoKeySize = fmt.Errorf("invalid key size: must have exactly %d characters", chacha20poly1305.KeySize)
...
func NewPasetoMaker(symmetricKey string) (Maker, error) {
	...
	return &PasetoMaker{paseto.NewV2(), []byte(symmetricKey)}, nil
}
